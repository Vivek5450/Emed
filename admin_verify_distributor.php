		...
		<div class="contact">
				<div class="container">
					...
					<div class="row">
						<div class="col-md-12">
						<?php
						$res1=mysql_query("select * from distributor_regis where status='0'");
						...
						if(mysql_num_rows($res1)>0)
						{
							...
							while($r1=mysql_fetch_array($res1))
							{
								...
								echo "<td><a href='admin_verify_distributor.php?vdid=$r1[0]'>VERIFY</a></td>";
								echo "<td><a href='admin_verify_distributor.php?nvdid=$r1[0]'>NOT VERIFY</a></td>";
								echo "</tr>";
							}
							echo "</table>";
						}else{
